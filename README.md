...
<head>
  ...
  <title>Portfólio de João Loss</title>
...
<body>
  ...
  <main>
    <section id="sobre">
      <h2>Sobre</h2>
      <figure>
        <img src="https://via.placeholder.com/240" alt="Retrato de João sorrindo de frente.">
        <figcaption>Foto ilustrativa do perfil</figcaption>
      </figure>
      <p>
        Olá! Sou o João e estou começando no desenvolvimento web.
  ...
  <footer>
    <small>&copy; 2025 João Loss. Todos os direitos reservados.</small>
  </footer>
